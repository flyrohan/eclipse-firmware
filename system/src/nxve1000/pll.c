...
#define	NXVE100X_CMU_BASE		0x43150200
#define	NXVE100X_PLL_BASE		0x43140000
#define	NXVE100X_ALIVE_FSM_BASE	0x43161000

/* CMU Register */
#define GLITCH_FREE_MUX_SET		NXVE100X_CMU_BASE	/* CLKSEL */

/* PLL Register */
#define PLLCTRL					(NXVE100X_PLL_BASE + 0x0) 	/* OSCCLK_MUXSEL, DIRTYFLAG, UPDATECONFIG_DIRECTLY */
#define	PLLCNT3					(NXVE100X_PLL_BASE + 0x1C) 	/* RUN3_MAXCOUNT */
#define	PLLCFG0					(NXVE100X_PLL_BASE + 0x20) 	/* LINK_BYPASS, LINK_RESETB */
#define	PLLCFG1					(NXVE100X_PLL_BASE + 0x30) 	/* LINK_P, LINK_M */
#define PLLCFG2					(NXVE100X_PLL_BASE + 0x40) 	/* LINK_S, LINK_ICP*/
#define PLLLOCKINT0				(NXVE100X_PLL_BASE + 0x60) 	/* RUNDONE_INTPEND_CLR */
#define ALIVEFSMOSCSOURCE		(NXVE100X_ALIVE_FSM_BASE + 0x178) /* ALIVETIMERSOURCE */
#define INTOSCTRIMCTRL			(NXVE100X_ALIVE_FSM_BASE + 0x280)
...
static void PLL_Change_PMS(PLLPMS *pms)
{
	...
	_WRITE_FIELD(GLITCH_FREE_MUX_SET, CLKSEL, 0x0);
	...
	_WRITE_FIELD(GLITCH_FREE_MUX_SET, CLKSEL, 0x1);
